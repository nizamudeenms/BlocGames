...
Game _$GameFromJson(Map<String, dynamic> json) => Game(
      ...
      filters: json['filters'] == null ? null : Filters.fromJson(json['filters'] as Map<String, dynamic>),
      nofollowCollections: (json['nofollow_collections'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
