...
FiltersYear _$FiltersYearFromJson(Map<String, dynamic> json) => FiltersYear(
      ...
      years: (json['years'] as List<dynamic>?)?.map((e) => YearGame.fromJson(e as Map<String, dynamic>)).toList(),
      nofollow: json['nofollow'] as bool?,
      count: json['count'] as int?,
    );

Map<String, dynamic> _$FiltersYearToJson(FiltersYear instance) => <String, dynamic>{
      'from': instance.from,
      'to': instance.to,
